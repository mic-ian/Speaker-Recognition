...
def main():
    ...
    train_dataset = FBanksCrossEntropyDataset('../feature_extraction/fbanks_train')
    ...
    test_dataset = FBanksCrossEntropyDataset('../feature_extraction/fbanks_test')
    ...
    for epoch in range(start, 15):
        train_loss, train_accuracy = train_loss, train_accuracy = train(model, device, train_loader, optimizer, epoch, 500)
